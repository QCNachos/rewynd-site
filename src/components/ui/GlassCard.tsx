...
export default function GlassCard({
  ...
  return (
    <div
      className={`group relative bg-[rgba(12,13,16,0.8)] border border-white/[0.06] rounded-2xl backdrop-blur-xl transition-all duration-500 overflow-hidden ${
        hover
          ? `hover:-translate-y-2 ${accent.border} ${accent.glow}`
          : ""
      } ${className}`}
    >
      <div
